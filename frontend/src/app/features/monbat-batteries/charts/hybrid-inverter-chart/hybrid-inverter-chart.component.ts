...
@Component({
  selector: 'app-hybrid-inverter-chart',
  imports: [],
  templateUrl: './hybrid-inverter-chart.component.html',
  styleUrl: './hybrid-inverter-chart.component.less',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HybridInverterChartComponent extends BaseChartComponentComponent<HybridInverterHistoricalData> {
