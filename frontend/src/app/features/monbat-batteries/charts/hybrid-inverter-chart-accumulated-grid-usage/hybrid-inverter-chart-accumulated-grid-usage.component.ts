...
@Component({
  selector: 'app-hybrid-inverter-chart-accumulated-grid-usage',
  imports: [],
  templateUrl: './hybrid-inverter-chart-accumulated-grid-usage.component.html',
  styleUrl: './hybrid-inverter-chart-accumulated-grid-usage.component.less',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HybridInverterChartAccumulatedGridUsageComponent extends BaseChartComponentComponent<HybridInverterHistoricalData> {
