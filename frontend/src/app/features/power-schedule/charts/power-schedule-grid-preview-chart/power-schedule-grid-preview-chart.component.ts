...
@Component({
  selector: 'app-power-schedule-grid-preview-chart',
  templateUrl: './power-schedule-grid-preview-chart.component.html',
  styleUrls: ['./power-schedule-grid-preview-chart.component.less'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class PowerScheduleGridPreviewChartComponent implements OnChanges, AfterViewInit, OnDestroy {
