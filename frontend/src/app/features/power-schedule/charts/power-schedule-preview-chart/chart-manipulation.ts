...
import {
  seriesOptions_ScheduleTargetFillBess,
  updateSeriesData_ScheduleTargetFillBess,
} from '../chart-series-schedule-target-fill-bess';
import {
...
export const chartOptions: Highcharts.Options = {
  ...
  title: {
    text: $localize`Power schedule preview`,
    margin: 5,
  },
  xAxis: {
    type: 'datetime',
...
export function updateData(chart: Highcharts.Chart, data: PowerSchedule | undefined) {
  ...
  updateSeriesData_ScheduleTargetFillBess(chart, data);
}

const plotBandId_PastTime = 'plotBandId_PastTime_PowerSchedule';
const plotBandId_CurrentInterval = 'plotBandId_CurrentInterval_PowerSchedule';
